...
| A | **N7-2 메타 경제 재설계 + 캐릭터별 특화** | 오너 지적: 엽전 수급 대비 강화 비용이 너무 싸고 종류가 적다. 비용 곡선 재설계 + 노드 대폭 확장 + **캐릭터별 전용 강화 분기** |
| B | **N3-18 기술 이펙트 재작업** | 오너 지적: 기술별 이펙트가 이상하다. 스케일·타이밍·색이 야간 팔레트와 안 맞고 스프라이트 재생이 어색한 것 전수 점검 |
