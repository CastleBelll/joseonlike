...
This set uses the owner-authored replacement sheets in `new_asset/owner/taoist.png` and `new_asset/owner/taoist_walk.png`. The approved clean-shaven face, crimson hair, anime eyes, blush, navy/teal robe, ringed staff, talisman, and straw hat come directly from those raster sources. `build_assets.py` performs chroma removal, premultiplied BOX reduction, source-hue quantization, proportion rebalance, and source-pixel frame assembly; nearest-neighbor sampling is used only for the final 16× export.

## Source art

| File | Canvas | SHA-256 | Contents used |
| --- | ---: | --- | --- |
| `new_asset/owner/taoist.png` | 2048×2048 | `C27141316B56356E54C06F958057A994DFF7C2E871DE956BD2D1F911B04E330C` | left full-body idle and right bust portrait |
| `new_asset/owner/taoist_walk.png` | 1536×1024 | `149E14311D86FC72DEFBF078D9656D45A628775D2868C9ECF5BCA3C7CBE637DE` | numbered top-row poses 1–4 |
