...
어린 시절 괴이의 저주로 마을 전체가 화염에 휩싸였다. 유일한 생존자인 그는 그 날의 비극을 반복하지 않기 위해 술법을 배웠다. 부적 한 장으로 백귀를 봉인할 수 있다는 말이 사실이었다. 이제 그는 이 땅 곳곳에서 벌어지는 괴이 현상마다 찾아가 봉인의 부적을 남긴다. 정령왕이 소비한 대나무숲도 그 중 한 곳이다.

---

# 3.1 지역: 대나무숲 (竹林)

대나무숲은 조선 남쪽 골짜기 깊숙한 곳이다. 한 때는 나무꾼의 쉼터였지만, 지금은 괴이의 온상이 되었다.

정령왕이 이곳을 지배한 이후로, 숲은 불빛도 없는 영원한 밤에 잠겼다. 도깨비들은 길을 잃은 나그네를 놀려먹고, 원혼들은 숲 속을 배회하며 울음을 낸다. 그 중심에는 정령왕의 심장이 뛰고 있다.

우치이 이곳에 온 것은 이 저주를 풀기 위함이다. 정령왕을 봉인하면, 숲의 밤이 걷힐 것이라 믿는다.
...
걷기는 4프레임 워크 사이클. 스타일 앵커: `new_asset/owner/`의 오너 제공
