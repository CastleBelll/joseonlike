...
const STRINGS := {
	...
	"storehouse.title": {"ko": "창고", "en": "Storehouse"},
	"storehouse.count_fmt": {"ko": "%d개", "en": "x%d"},
	"storehouse.empty": {"ko": "선반이 비었다. 밤에서 주워 온 것이 여기 쌓인다.", "en": "The shelves are bare. Whatever the night gives up is stored here."},
	"storehouse.spare": {"ko": "지금 쓸 곳 없음", "en": "Nothing needs it right now"},
	"storehouse.needed_fmt": {"ko": "해금·수련에 %d개 필요 — 충분하다", "en": "%d needed for unlocks and training — enough in stock"},
	"storehouse.short_fmt": {"ko": "해금·수련에 %d개 필요 — %d개 모자라다", "en": "%d needed for unlocks and training — %d short"},
	...
	"smithy.bill_fmt": {"ko": "재료 %s", "en": "Materials %s"},
...
Damage %s→%s",
	...
	"장터": "Market",
	"묵헌": "Mukheon",
	"돌아왔군. 사관 묵헌 — 밤에 든 것을 기록하는 자다. 그대의 밤도 방금 장부에 올렸다.": "So you returned. Mukheon, archivist — I record what the night takes in. Yours just went into the ledger.",
	"밤에서 지는 것도 벌이다. 엽전과 재료는 창고에 남고, 괴이록에는 새 기록이 쌓인다.": "Even a lost night pays. Coins and materials stay in the storehouse, and the bestiary gains new pages.",
	"수련에서 몸을 벼려라. 어제보다 강하게 나가는 것 — 그것이 이 본거지의 법도다.": "Temper yourself in training. Go out stronger than yesterday — that is the law of this camp.",
	"준비가 되면 출정하라. 밤은 언제나 기다린다.": "Sortie when you are ready. The night always waits.",
	"밤이 깊었다": "The Night Deepens",
	"이번 밤 수확": "Night's harvest",
	"재료 +%d": "materials +%d",
	"기록 +%d쪽": "pages +%d",
	"업적 %d개 달성 — 업적에서 확인": "%d achievements — see the list",
	"다음 강화": "Next upgrade",
	"%s — 지금 강화 가능": "%s — ready to buy",
	"%s까지 %d냥": "%s — %d more coins",
	"업적 %d개 더 달성 — 업적에서 확인": "%d more achievements — see the list",
	...
	"지역 선택": "Choose Region",
	"출정지": "Departure",
	"첫 괴수를 쓰러뜨리면 다음 밤이 열린다": "Down the first beast to open the next night",
	"업적 달성": "Achievement earned",
	"준비 중": "Not ready",
	"승리": "Victory",
	"패배": "Defeat",
	"죽음": "Killed by",
	"패인": "Lost to",
	"보스를 처치하지 못했다": "The boss outlived the night",
	"생존 시간": "Survived",
	"처치": "Kills",
	"엽전": "Coins",
	"보유 엽전": "Coins Held",
